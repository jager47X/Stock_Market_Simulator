...
RealEstateStock::RealEstateStock(string ind, string name, double total, double own, double day_c, double val, double share) :Stock(ind, name, own, total, day_c, val, share) {
	srand(time(NULL));    owned=0;
    change=0;
}


double RealEstateStock::stockChange() {
